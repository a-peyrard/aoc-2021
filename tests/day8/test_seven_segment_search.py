...
from aoc.day8.seven_segment_search import count_digit_part1, decode_outputs
...
""".splitlines(keepends=True)
    ...
    def test_should_validate_part2_given_mini_sample(self):
        # GIVEN
        signals = TestCountDigit._parse_input(
...
""".splitlines(keepends=True)
        ...
        # WHEN
        res = decode_outputs(signals)

        # THEN
        assert_that(res, equal_to(5353))

    def test_should_validate_part2_given_sample(self):
        # GIVEN
        signals = TestCountDigit._parse_input(
            lines="""be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb | fdgacbe cefdb cefbgd gcbe
edbfga begcd cbg gc gcadebf fbgde acbgfd abcde gfcbed gfec | fcgedb cgb dgebacf gc
...
""".splitlines(keepends=True)
        ...
        # THEN
        assert_that(res, equal_to(61229))

    def test_should_count_outputs_for_input(self):
        # GIVEN
        signals = parse_input_file(
            origin=__file__,
            filename='input.txt',
        ...
        # THEN
        assert_that(res, equal_to(1070188))
